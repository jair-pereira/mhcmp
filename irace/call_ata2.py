...
def main(args):
    ...
    parser.add_argument('--w0'   , dest='w0'   , type=float, help="Real value:")
    ...
    ## loop over problems ##
    problem = suite[0]
    result = ata(problem, maxnfe=nfe, n=int(args.n), tolerance=args.tol, w0=args.w0, w=args.w, seed=int(args.seed))
